% W04_HEADING_SIGN  헤딩 D 항의 세 가지 선택을 같은 배에 걸어 본다.
%
%   왜 필요한가
...
%
%   비교하는 세 가지
%     (A) -Kd * r        요각속도 되먹임        <- W04_3/W04_4 가 쓰는 것
...
%
%   배 모델 — 5주차 운동모델의 요 자유도만 떼어 낸 것 (계수도 같다)
...
Izz = 653;      % 요 관성 [kg m^2]        — W05_setup 과 같은 값
Nr  = 800;      % 선형 요 항력
Nrr = 800;      % 2차 요 항력
...
exportgraphics(h, fullfile(fileparts(mfilename('fullpath')), 'img', 'W04_heading_dterm.png'), 'Resolution', 110);
fprintf('그림: img/W04_heading_dterm.png\n');
