% W04_POLE_PLACE  헤딩 게인을 "적당히" 가 아니라 극배치로 정한다.
%
%   >> W04_pole_place
%
%   무엇을 하는가
...
%% 그림 --------------------------------------------------------------
C = lines(numel(res));
h = figure('Name','W04 극배치','Position',[80 80 1160 470],'Color','w');
...
exportgraphics(h, fullfile(d, 'W04_pole_place.png'), 'Resolution', 110);
fprintf('\n그림: img/W04_pole_place.png\n');
