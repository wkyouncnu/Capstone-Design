function build_a1_0_models()
% BUILD_A1_0_MODELS  Simulink 속성 입문 실습 모델 12개를 생성한다.
%
%   실습마다 두 개씩 만들어진다.
...
% =====================================================================
% 공통 헬퍼  (W04_simulink/build_w04_models.m 의 관용구를 그대로 따른다)
% =====================================================================
function fresh(m)
...
function build_SB5_todo()
    ...
    note(m, sprintf(['[E] 할 일 — 한 번에 하나씩, 매번 Run 해서 Scope 를 볼 것\n' ...
        ...
        '   -> 이번엔 두 목표(2, 0.5)를 모두 맞춘다 (아직 포화 없음)\n' ...
...
function build_SB6_todo()
    ...
    note(m, sprintf(['[F] 할 일\n' ...
        ...
        '2. SB_setup 없이 Run 하면 변수를 못 찾는다는 오류가 난다. 오류를 먼저 볼 것\n' ...
