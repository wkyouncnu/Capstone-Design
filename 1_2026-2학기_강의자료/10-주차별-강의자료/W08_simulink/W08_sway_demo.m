function S = W08_sway_demo(T_open, Y_cmd, pos_sign)
%W08_SWAY_DEMO  개루프 횡이동 실험 — 8주차 §E-2 를 재현한다.
%
%   먼저 W08_setup 을 실행해 T_pinv 를 만들어 둔다. VRX 가 떠 있어야 한다.
%
%     W08_setup
%     S = W08_sway_demo;          % 25초, 횡력 200 N
%     S = W08_sway_demo(25, 200); % 같은 뜻
%
...
% --- 배분 계산 -------------------------------------------------------
T_pinv = evalin('base','T_pinv');       % W08_setup 이 만든 의사역행렬
tau = [0; Y_cmd; 0];
