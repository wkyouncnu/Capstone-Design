function W08_animate(eta, eta_d, Dact, Tact, t)
% W08_ANIMATE  DP 주행을 실시간으로 그린다.
%
%   선체는 5~7주차와 같은 모양 — 선수는 세모, 선미는 네모.
...
if isempty(hFig) || ~isvalid(hFig) || t < tPrev
    hFig = figure('Name','W08 DP 실시간','Color','w','Position',[80 80 720 640]);
