% W07_CRAB_DEMO  조류 속에서 뱃머리(psi)와 진행 방향(chi)이 벌어지는 것을 시간축으로 본다.
%
%   >> W07_setup
%   >> W07_crab_demo
%
...
%   적용되지 않는다. W07_setup 은 둘을 함께 계산하므로, 스크립트에서 바꿀 때는
...
%% 그림 --------------------------------------------------------------
h = figure('Name','W07 크랩각','Position',[80 80 1150 540],'Color','w');
...
exportgraphics(h, fullfile(d, 'W07_crab_demo.png'), 'Resolution', 110);
fprintf('\n그림: img/W07_crab_demo.png\n');
