...
%
%     W07_0_offline.slx   오프라인 — Gazebo 없이 돈다
%     W07_1_vrx.slx       VRX 연동
%
...
%
%   안에 들어가는 것
%     WpManager  웨이포인트 관리 + LOS (5주차)
%     LoiterVF   원 궤도 벡터필드   (6주차)
%     TurnCount  몇 바퀴 돌았는지
%     설정 상수와 한 스텝 지연들
...
'chi  = atan2(sin(c), cos(c));'];
    ...
    note(m,'n1', ['W07 실습 D  —  VRX 연동 (Gazebo 필요)' newline ...
        'Guidance -> Mission -> Inner Loop -> Thrusters -> Gazebo -> Navigation' newline ...
        '유도부·미션·내부루프·게인은 W07_0_offline 과 완전히 같다.' newline ...
        '운동모델만 Gazebo 로 바뀐다.' newline ...
        '실행 전: (1) W07_setup  (2) VRX 기동  (3) 페이싱을 RTF 에 맞출 것'], 300, -120);
