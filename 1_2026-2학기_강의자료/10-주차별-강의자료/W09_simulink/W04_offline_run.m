function S = W04_offline_run(T_end)
% W04_OFFLINE_RUN  운동모델 + 센서 모델(W04_0_offline)로 수신 주기와 센서 값을 먼저 본다.
%
%   >> W04_setup
%   >> S = W04_offline_run          % VRX 없이 T_end 초 (기본 W04_setup 의 20 초)
%
%   무엇을 보는가 (4주차 1-5 절, 2-8-0)
...
fprintf('W04_0_offline 실행 — 좌 %+.0f N / 우 %+.0f N, %g 초 (VRX 없음)\n', ...
