...
| 3 | [[W03_Gazebo_VRX_구축과_좌표계]] | — | Gazebo Garden · VRX 설치와 실행 · 6자유도 · ENU/NED · 쿼터니언 · TF2 · Simulink 좌표 변환 (모델 4개) |
| 4 | [[W04_VRX_심화_모델구조와_토픽조사]] | — | WAM-V URDF·Xacro · 센서 배치 수정 · 토픽 전수조사 · Mapviz · Simulink 수신 주기·QoS (모델 2개) |
...
| 6 | [[W06_Simulink_ROS2_연동과_첫_제어기]] | — | Simulink↔ROS 2 · PID 입문 · 첫 제어기 · **오프라인 WAM-V** (모델 8개) |
...
6\~10주차 모델(6주차 보충 26 · 6주차 8 · 7\~10주차 각 2)은 모두 같은 규칙으로 그려져 있다.
