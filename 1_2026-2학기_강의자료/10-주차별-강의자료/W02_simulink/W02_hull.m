function [X, Y, hx, hy] = W02_hull(x, y, th, L)
% W02_HULL  선박 모양 다각형 — 선미는 네모, 선수는 뾰족하다.
%
%   [X, Y]         = W02_hull(x, y, th)      선체 윤곽 (patch 에 그대로 넣는다)
%   [X, Y, hx, hy] = W02_hull(x, y, th, L)   선수 방향선까지
%
%   입력
...
if nargin < 4 || isempty(L), L = 0.35; end
B = 0.45 * L;                         % 반폭
