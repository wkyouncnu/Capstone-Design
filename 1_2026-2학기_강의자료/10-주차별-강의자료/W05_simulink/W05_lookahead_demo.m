% W05_LOOKAHEAD_DEMO  lookahead distance Δ 하나만 바꿔 경로 복귀를 비교한다.
%
%   >> W05_setup
%   >> W05_lookahead_demo
%
...
%% 그림 --------------------------------------------------------------
h = figure('Name','W05  lookahead distance 비교', ...
...
exportgraphics(h, fullfile(d, 'W05_lookahead_demo.png'), 'Resolution', 130);
...
fprintf('그림: img/W05_lookahead_demo.png\n');
