function S = W05_plot(out, ttl)
% W05_PLOT  시뮬레이션 결과를 그림 6장으로 그리고 성능 지표를 표로 낸다.
%
%   사용법
%     >> W05_setup
%     >> out = sim('W05_0_offline');
%     >> W05_plot(out, 'LOS / 조류 없음')
%
...
S.fig = figure('Name',['W05  ' ttl], 'Position', [80 60 1200 780], 'Color','w');
...
% ---- 6. 추력과 회전수 --------------------------------------------------
figure('Name', ['W05 추진기  ' ttl], 'Position',[140 120 900 380], 'Color','w');
subplot(1,2,1);
