function S = W06_plot(out, ttl)
% W06_PLOT  로이터링 결과를 그림 6장으로 그리고 성능 지표를 낸다.
%
%   >> W06_setup            % 실행하면 자동으로 이 함수가 불린다
%   >> W06_plot(out, '설명')
%
%   반환값 S
...
S.fig = figure('Name',['W06  ' ttl], 'Position',[70 50 1220 800], 'Color','w');
...
% ---- 6. 추력과 크랩각 -------------------------------------------------
figure('Name',['W06 추진기  ' ttl], 'Position',[130 110 950 380], 'Color','w');
subplot(1,2,1);
