...
> - 4주차 H절의 `HeadingCtrl` 과 **같은 식**임. 여기서는 지령이 계속 바뀜
...
- 4주차에 Gazebo 로 실측한 값은 **1.332 m/s** 였음 (4주차 J절)
...
| MATLAB 에서 토픽이 안 보임 | Domain ID 불일치 | 4주차 B절 참조 |
...
- 준비물
  - 과제 5 의 그래프와 표
  - **6주차는 중간 발표 주간임** — 팀별 Term Project 제안서 초안을 준비할 것

> [!important] 중간 발표
> 평가의 **15%** 임. 전반부 데모(5주차까지 만든 것)와 Term Project 제안서를 냄
