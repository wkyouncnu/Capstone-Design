...
| 구간 | 월드 | 요구 기술 | 관련 주차 |
|---|---|---|---|
| ① 이안 · 항주 | `sydney_regatta` | Simulink 헤딩·속도 제어 + LOS 유도 | 4·5주 |
| ② 장애물 회피 | `sydney_regatta_ca` (부표 36개) | LiDAR 클러스터링 + VFH / DWA | 11·12주 |
| ③ 위치 유지 | 지정 부표 | DP — 위치 PID + 헤딩 PID + 추력 배분 | 8주 |
| ④ 자율 도킹 | `scan_dock_deliver_full` (3 베이) | 표식 인식 + RANSAC 도크 평면 + 접안 제어 | 13·14주 |
