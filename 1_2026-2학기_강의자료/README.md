...
| 9 | [[W09_VRX_심화_모델구조와_토픽조사]] | 11장 · PDF 46쪽 | WAM-V URDF·Xacro · 센서 배치 · 토픽 전수조사 · Mapviz · **과제 월드와 채점** · **ros2 bag** · **센서 모델** · **모델 3개 배포 (오프라인 `W09_0_offline` 먼저)** · **실시간 화면** |
...
| 4 | `w04-ssa.svg` | $\pm180°$ 이음매와 `ssa` — 함수 자체의 모양 (2-11) |
| 4 | `w04-ssa-circle.svg` | 같은 명령, 짧은 길 20° 와 먼 길 340° — 이득이 받는 수까지 (2-11) |
