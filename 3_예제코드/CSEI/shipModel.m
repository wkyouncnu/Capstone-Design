...
%     stParam.veh_info.L = 12.588;
%     stParam.veh_info.L = 6;
%     stParam.veh_info.B = 1.5;
    stParam.veh_info.L = 1.2;
    stParam.veh_info.B = 0.2;
    stParam.veh_info.buffer = 2.5*stParam.veh_info.L;
    stParam.veh_info.headDir = 5;
    stParam.veh_info.ssz = 4.88; % buffer = safe separation zone (ssz)
...
%     vehy = stParam.veh_info.B*[1,0,-1,-1,1,1]';
    vehx = stParam.veh_info.B*[1,0,-1,-1,1,1]';
    vehy = stParam.veh_info.L*[0.5, 1,0.5,-1,-1, 0.5]' ;
    ...
    h(3) = plot( [veh_x veh_x + (stParam.veh_info.headDir * veh_spd) * cos(veh_psi)], [veh_y veh_y + (stParam.veh_info.headDir * veh_spd) * sin(veh_psi)], 'b--', 'LineWidth',1 ); % heading line depending on speed
