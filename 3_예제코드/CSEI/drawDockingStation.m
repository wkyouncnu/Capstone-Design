% function drawDockingStation(axis, center_x, center_y, orientation_deg, width, height, thickness)
function drawDockingStation(center_x, center_y, orientation_deg, width, height, thickness)
...
plot(center_x, center_y, 'ro', 'LineWidth', 1.5, 'MarkerSize', 6);
